 ...
 *   ),
 *   handlers = {
 *     "list_builder" = "Drupal\reservation\ReservationListBuilder",
 ...
 *   admin_permission = "administer reservation",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "label",
 *     "uuid" = "uuid",
